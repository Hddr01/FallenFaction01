<!-- components/team/TeamDetails.vue -->
<template>
  <div class="min-h-screen bg-[var(--color-background)] py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
              ...
              <div class="mt-5 sm:mt-0 sm:ml-6 sm:flex-shrink-0 sm:flex sm:items-center">
                <div class="flex space-x-3">
                  ...
                  <div v-if="isCreator || isAdmin" class="flex space-x-2">
                    <button @click="showEditModal = true"
                            class="inline-flex items-center px-4 py-2 border border-[var(--color-border)] text-sm font-medium rounded-md text-[var(--color-text)] bg-[var(--color-background)] hover:bg-[var(--color-background-mute)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-border-hover)] transition-all duration-200">
                      Edit Team
                    </button>
      ...
      <!-- Edit Team Modal - CENTERED -->
      <div v-if="showEditModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-[var(--color-background-soft)] border border-[var(--color-border)] rounded-lg shadow-xl w-full max-w-md mx-auto">
          <div class="p-6">
            <div class="flex items-center justify-between mb-6">
              <h3 class="text-lg font-medium text-[var(--color-heading)]">Edit Team</h3>
              <button @click="closeEditModal" class="text-[var(--color-text)] opacity-50 hover:opacity-75 transition-opacity duration-200">
