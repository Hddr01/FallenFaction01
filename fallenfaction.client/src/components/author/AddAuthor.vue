<!-- components/author/AddAuthor.vue -->
<template>
  <div class="min-h-screen bg-[var(--color-background)] py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
      <!-- Page Header -->
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-[var(--color-heading)]">Add New Author</h1>
        <p class="mt-2 text-[var(--color-text)] opacity-75">Add a new author to the database</p>
      </div>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="space-y-3">
              ...
              <Input id="name"
                     ...
                     placeholder="Enter author name (English preferred)"
                     maxlength="200"
                     required />
    ...
    setup() {
      ...
      const handleSubmit = async () => {
        ...
        try {
          ...
          if (result.success) {
            message.text = result.message || 'Author created successfully!';
