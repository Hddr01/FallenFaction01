                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="start" class="w-48">
                    <DropdownMenuItem as-child>
                      <a :href="`/${buildTitleSlug(titleData.originalTitle, titleData.id)}/AddChapter`" class="flex items-center cursor-pointer">
                    ...
                    <DropdownMenuItem as-child>
                      <a :href="`/${buildTitleSlug(titleData.originalTitle, titleData.id)}/BulkAddChapters`" class="flex items-center cursor-pointer">
                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
