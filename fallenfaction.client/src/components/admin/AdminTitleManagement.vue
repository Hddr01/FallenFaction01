...
<script setup>
  ...
  // ── Type helpers ──────────────────────────────────────────────────────────────
  const TYPE_NAMES = { 1: 'Novel', 2: 'Light Novel', 3: 'Web Novel', 4: 'Short Story', 5: 'Wuxia', 6: 'Xianxia', 7: 'Xuanhuan', 8: 'Classic Fiction' }
  const TYPE_COLORS = {
    ...
    5: 'bg-orange-900/40 text-orange-300 border border-orange-700/40',
    6: 'bg-green-900/40 text-green-300 border border-green-700/40',
    7: 'bg-teal-900/40 text-teal-300 border border-teal-700/40',
    8: 'bg-pink-900/40 text-pink-300 border border-pink-700/40',
  }
