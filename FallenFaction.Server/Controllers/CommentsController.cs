    ...
    public class CommentsController : ControllerBase
    {
            ...
            bool isAdmin)
        {
            ...
            var dto = new CommentDto
            {
                ...
                DeletedByUserName = isAdmin ? (comment.DeletedByUser?.ProfileName ?? comment.DeletedByUser?.UserName) : null,
                DeletionReason = isAdmin ? comment.DeletionReason : null,
                IsPinned = comment.IsPinned,
                PinnedAt = comment.PinnedAt,
                PinnedByUserName = comment.PinnedByUser?.ProfileName ?? comment.PinnedByUser?.UserName,
