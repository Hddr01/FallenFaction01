    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChapterView", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTeamRolePermission", x => new { x.AppUserId, x.TeamId, x.PermissionId });
                    table.ForeignKey(
                        name: "FK_UserTeamRolePermission_UserTeamPermissions_PermissionId",
                        column: x => x.PermissionId,
                        principalTable: "UserTeamPermissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTeamRolePermission_UserTeamRoles_AppUserId_TeamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTeamRolePermission_PermissionId",
                table: "UserTeamRolePermission",
                column: "PermissionId");
